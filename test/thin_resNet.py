...
def conNet(input_shape,weight_decay,pool):
    ...
    # x2 = identity_block_2D(x2, 3, [48, 48, 96], stage=2, block='c', trainable=True)
    # ===============================================
    ...
    # x3 = identity_block_2D(x3, 3, [96, 96, 128], stage=3, block='d', trainable=True)
    # ===============================================
    ...
    # x4 = identity_block_2D(x4, 3, [128, 128, 256], stage=4, block='d', trainable=True)
    # x4 = identity_block_2D(x4, 3, [128, 128, 256], stage=4, block='e', trainable=True)
    # x4 = identity_block_2D(x4, 3, [128, 128, 256], stage=4, block='f', trainable=True)
    # ===============================================
