...
def identity_block_2D_34(input_tensor, kernel_size, filters, stage, block, trainable=True,weight_decay = c.WEIGHT_DECAY):
...
def conv_block_2D_34(input_tensor, kernel_size, filters, stage, block, strides=(2, 2), trainable=True,weight_decay = c.WEIGHT_DECAY):
...
def conNet(input_shape,weight_decay,pool):
    ...
    # ===============================================
    x2 = conv_block_2D_34(x1, 3, [64,64], stage=2, block='a', strides=(1, 1), trainable=True)
    x2 = identity_block_2D_34(x2, 3, [64,64], stage=2, block='b', trainable=True)
    x2 = identity_block_2D_34(x2, 3, [64,64], stage=2, block='c', trainable=True)
    # ===============================================
    #            Convolution Section 3
    # ===============================================
    x3 = conv_block_2D_34(x2, 3, [128,128], stage=3, block='a', trainable=True)
    x3 = identity_block_2D_34(x3, 3, [128,128], stage=3, block='b', trainable=True)
    x3 = identity_block_2D_34(x3, 3, [128,128], stage=3, block='c', trainable=True)
    x3 = identity_block_2D_34(x3, 3, [128,128], stage=3, block='d', trainable=True)
    # ===============================================
    #            Convolution Section 4
    # ===============================================
    x4 = conv_block_2D_34(x3, 3, [256, 256], stage=4, block='a', trainable=True)
    x4 = identity_block_2D_34(x4, 3, [256, 256], stage=4, block='b', trainable=True)
    x4 = identity_block_2D_34(x4, 3, [256, 256], stage=4, block='c', trainable=True)
    x4 = identity_block_2D_34(x4, 3, [256, 256], stage=4, block='d', trainable=True)
    x4 = identity_block_2D_34(x4, 3, [256, 256], stage=4, block='e', trainable=True)
    x4 = identity_block_2D_34(x4, 3, [256, 256], stage=4, block='f', trainable=True)
    # ===============================================
    #            Convolution Section 5
    # ===============================================
    x5 = conv_block_2D_34(x4, 3, [512, 512], stage=5, block='a', trainable=True)
    x5 = identity_block_2D_34(x5, 3, [512, 512], stage=5, block='b', trainable=True)
    x5 = identity_block_2D_34(x5, 3, [512, 512], stage=5, block='c', trainable=True)
