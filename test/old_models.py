...
def conNet_87_for_64(input_shape,weight_decay,pool):
    '''
    train: 0 ~ 30  0.001
           35 ~ 85  0.0001
           90 ~ 115  0.00006(2)
...
def conNet_75_for_64(input_shape,weight_decay,pool):
    '''
    train: 0 ~ 30  0.001
           35 ~ 85  0.0001
           90 ~ 115  0.00006(2)
...
def test():
    ...
    model = conNet_79_for_128(input_shape,c.WEIGHT_DECAY,c.POOL)
